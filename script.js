const dataBase = [
    ...
    {name:'header-basket',
        ...
        path:`<span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" focusable="false" height="24px" width = "24px" style="margin-right:3px; margin-top:3px">
